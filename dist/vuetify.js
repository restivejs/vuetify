...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__custom_components__ = __webpack_require__(236);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function Vuetify(Vue, args) {
  ...
  Vue.use(__WEBPACK_IMPORTED_MODULE_4__custom_components__);
}
  ...
  methods: {
    ...
    getKey: function getKey(item, index) {
      if (this.itemKey) {
        ...
        return (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' ? index : value;
      }
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__RelativeBar__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TreeList__ = __webpack_require__(238);



var components = {
  VRelativeBar: __WEBPACK_IMPORTED_MODULE_0__RelativeBar__["a" /* default */],
  VTreeList: __WEBPACK_IMPORTED_MODULE_1__TreeList__["a" /* default */]
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_TreeList_vue__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20229dd4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TreeList_vue__ = __webpack_require__(241);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20229dd4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TreeList_vue__["a" /* default */],
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.isNode)?_c('v-list-group',_vm._b({},'v-list-group',{ 'sub-group': !_vm.root },false),[_c('v-list-tile',{attrs:{"slot":"activator","ripple":""},slot:"activator"},[_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v(_vm._s(_vm.model[_vm.itemText]))])],1)],1),_vm._v(" "),_vm._l((_vm.model.children),function(item,index){return _c('v-tree-list',{key:index,attrs:{"model":item,"parent":_vm.model,"item-text":_vm.itemText}})})],2):_c('v-list-tile',_vm._b({attrs:{"disabled":_vm.model.disabled,"target":_vm.model.target,"ripple":""}},'v-list-tile',{
  to: !_vm.model.target ? _vm.model.href : null,
  href: _vm.model.target && _vm.model.href
},false),[_c('v-list-tile-action',[(_vm.model.icon)?_c('v-icon',[_vm._v(_vm._s(_vm.model.icon))]):_vm._e()],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v(_vm._s(_vm.model[_vm.itemText]))])],1),_vm._v(" "),(_vm.model.badge)?_c('v-chip',{attrs:{"color":"red lighten-1","text-color":"white","small":"","disabled":""}},[_vm._v(_vm._s(_vm.model.badge))]):_vm._e()],1)}
var staticRenderFns = []
